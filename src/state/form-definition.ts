...
import { DEFAULT_FORM_SETTINGS, DEFAULT_LABEL_WIDTH } from '../utils/form-layout'
...
// 表单级设置默认值（未显式提供时使用）：与 dsl/keys.ts 的 ensureDslKeys 兜底同源
const DEFAULT_FORM_NAME = 'form'
const DEFAULT_SETTINGS: FormSettings = DEFAULT_FORM_SETTINGS
