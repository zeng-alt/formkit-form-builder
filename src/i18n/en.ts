export default {
  ...
  elements: {
    ...
    badge: {
      name: 'Badge',
      label: 'Badge',
      description: 'Naive UI NBadge container (accepts a single element, the dot overlays it)',
    },
    tabs: { name: 'Tabs', label: 'Tabs', description: 'Naive UI Tabs container' },
    steps: {
      name: 'Steps wizard',
      label: 'Steps wizard',
      description: 'Naive UI Steps wizard (root canvas only, single instance per form)',
    },
    group: {
      name: 'Group',
      label: 'Group',
    ...
    dataTable: {
      name: 'Data Table',
      label: 'Data Table',
      description: 'n-data-table (fixed / remote data, pagination support)',
    },
  },
} as const
