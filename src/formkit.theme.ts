...
const classes: Record<string, Record<string, boolean>> = {
  ...
  range__input: {
    ...
    'dark:[&::-webkit-slider-thumb]:group-data-[disabled]:!ring-zinc-700': true,
  ...
  togglebuttons__input: {
    ...
    'not-first:not-last:!rounded-none': true,
    ...
    'group-data-[vertical=false]/options:not-first:not-last:!border-r-0': true,
    'group-data-[vertical=false]/options:group-last/option:!border-r': true,
    'group-data-[vertical=false]/options:not-first:not-last:aria-[pressed=true]:border-x-green-500': true,
    ...
    'dark:group-data-[vertical=false]/options:not-first:not-last:aria-[pressed=true]:border-x-amber-600': true,
    ...
    'group-data-[vertical=true]/options:not-first:not-last:aria-[pressed=true]:border-y-green-500': true,
    ...
    'dark:group-data-[vertical=true]/options:not-first:not-last:aria-[pressed=true]:border-y-amber-600': true,
  ...
  'multi-step__tab': {
    ...
    'dark:group-data-[tab-style=progress]/wrapper:before:border-zinc-800': true,
